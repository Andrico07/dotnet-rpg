    ...
    public class FightService : IFightService
    {
                ...
                while(!defeated)
                {
                    foreach(var attacker in characters)
                    {
                        ...
                        else if(!useWeapon && attacker.Skills is not null)
                        {
                            ...
                            damage = DoSkillAttck(attacker, opponent, skill);
                        }
                        else
                        {
                            response.Data.Log
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                int damage = DoSkillAttck(attacker, opponent, skill);
        ...
        private static int DoSkillAttck(Character attacker, Character opponent, Skill skill)
        {
